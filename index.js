  ...
  module.exports = function(grunt, options) {
    ...
    grunt.initConfig({
      ...
      less: {
        main: {
          options: {
            paths: ["node_modules", "" + libDir + "/css", "" + srcDir + "/css"],
            compress: minify,
            yuicompress: minify,
            modifyVars: {
              "lib-dir": "\"" + libDir + "\""
          ...
          files: createObject(["" + distDir + "/temp/main.noembed.css", "" + libDir + "/css/main.less"])
        }
      },
      cssUrlEmbed: {
        main: {
          ...
          files: createObject(["" + distDir + "/temp/main.css", "" + distDir + "/temp/main.noembed.css"])
        }
      },
      browserify: {
        main: {
    ...
    grunt.registerTask("pandoc", "Run pandoc", function(target) {
      ...
      switch (target) {
        ...
        case "epub":
          ...
          extras = joinLines("--epub-stylesheet=" + distDir + "/temp/main.css\n--epub-cover-image=" + srcDir + "/covers/epub-cover.png\n--include-before-body=" + libDir + "/templates/cover-notes.html");
