...
(function() {
  ...
  module.exports = function(grunt, options) {
    ...
    tplSrcDir = (ref15 = (ref16 = options.dir) != null ? ref16.template : void 0) != null ? ref15 : libDir + "/templates";
    ...
    grunt.registerTask("pandoc", "Run pandoc", function(target, preview) {
      var command, crossrefFilter, extras, filters, metadata, output, pages, ref21, ref22, ref23, ref24, template, variables;
      if (preview == null) {
        preview = false;
      }
      if (target == null) {
